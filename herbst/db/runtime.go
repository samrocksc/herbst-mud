...
func init() {
	...
	characterDescIsTest := characterFields[5].Descriptor()
	...
	characterDescGoldCredits := characterFields[17].Descriptor()
	...
	characterDescConstitution := characterFields[18].Descriptor()
	...
	characterDescStrength := characterFields[21].Descriptor()
	...
	characterDescDexterity := characterFields[22].Descriptor()
	...
	characterDescIntelligence := characterFields[23].Descriptor()
	...
	characterDescWisdom := characterFields[24].Descriptor()
	...
	characterDescSkillBlades := characterFields[25].Descriptor()
	...
	characterDescSkillStaves := characterFields[26].Descriptor()
	...
	characterDescSkillKnives := characterFields[27].Descriptor()
	...
	characterDescSkillMartial := characterFields[28].Descriptor()
	...
	characterDescSkillBrawling := characterFields[29].Descriptor()
	...
	characterDescSkillTech := characterFields[30].Descriptor()
	...
	characterDescSkillLightArmor := characterFields[31].Descriptor()
	...
	characterDescSkillClothArmor := characterFields[32].Descriptor()
	...
	characterDescSkillHeavyArmor := characterFields[33].Descriptor()
