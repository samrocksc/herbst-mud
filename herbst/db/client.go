...
func (c *Client) Intercept(interceptors ...Interceptor) {
	...
	c.Talent.Intercept(interceptors...)
...
func (c *CharacterClient) QuerySkills(_m *Character) *SkillQuery {
...
func (c *CharacterClient) QueryTalents(_m *Character) *TalentQuery {
...
func (c *TalentClient) QueryCharacters(_m *Talent) *CharacterQuery {
	query := (&CharacterClient{config: c.config}).Query()
	query.path = func(context.Context) (fromV *sql.Selector, _ error) {
		id := _m.ID
		step := sqlgraph.NewStep(
...
type (
	hooks struct {
		Character, Room, Skill, Talent, User []ent.Hook
	}
	inters struct {
		Character, Room, Skill, Talent, User []ent.Interceptor
	}
)
