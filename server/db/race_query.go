...
func (_q *RaceQuery) Where(ps ...predicate.Race) *RaceQuery {
	_q.predicates = append(_q.predicates, ps...)
	return _q
}

// Limit the number of records to be returned by this query.
func (_q *RaceQuery) Limit(limit int) *RaceQuery {
	_q.ctx.Limit = &limit
	return _q
}

// Offset to start from.
func (_q *RaceQuery) Offset(offset int) *RaceQuery {
...
func (_q *RaceQuery) Unique(unique bool) *RaceQuery {
...
func (_q *RaceQuery) First(ctx context.Context) (*Race, error) {
...
func (_q *RaceQuery) FirstX(ctx context.Context) *Race {
...
func (_q *RaceQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *RaceQuery) FirstIDX(ctx context.Context) int {
...
func (_q *RaceQuery) Only(ctx context.Context) (*Race, error) {
...
func (_q *RaceQuery) OnlyX(ctx context.Context) *Race {
...
func (_q *RaceQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (_q *RaceQuery) OnlyIDX(ctx context.Context) int {
...
func (_q *RaceQuery) All(ctx context.Context) ([]*Race, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryAll)
	if err := _q.prepareQuery(ctx); err != nil {
		return nil, err
	}
	qr := querierAll[[]*Race, *RaceQuery]()
	return withInterceptors[[]*Race](ctx, _q, qr, _q.inters)
}

// AllX is like All, but panics if an error occurs.
func (_q *RaceQuery) AllX(ctx context.Context) []*Race {
...
func (_q *RaceQuery) IDs(ctx context.Context) (ids []int, err error) {
	if _q.ctx.Unique == nil && _q.path != nil {
		_q.Unique(true)
	}
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryIDs)
	if err = _q.Select(race.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *RaceQuery) IDsX(ctx context.Context) []int {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *RaceQuery) Count(ctx context.Context) (int, error) {
	ctx = setContextOp(ctx, _q.ctx, ent.OpQueryCount)
	if err := _q.prepareQuery(ctx); err != nil {
		return 0, err
	}
	return withInterceptors[int](ctx, _q, querierCount[*RaceQuery](), _q.inters)
}

// CountX is like Count, but panics if an error occurs.
func (_q *RaceQuery) CountX(ctx context.Context) int {
...
func (_q *RaceQuery) Exist(ctx context.Context) (bool, error) {
...
func (_q *RaceQuery) ExistX(ctx context.Context) bool {
...
func (_q *RaceQuery) Clone() *RaceQuery {
	if _q == nil {
		return nil
	}
	return &RaceQuery{
...
func (_q *RaceQuery) Select(fields ...string) *RaceSelect {
	...
	sbuild := &RaceSelect{RaceQuery: _q}
...
func (_q *RaceQuery) Aggregate(fns ...AggregateFunc) *RaceSelect {
	return _q.Select().Aggregate(fns...)
}

func (_q *RaceQuery) prepareQuery(ctx context.Context) error {
...
func (_q *RaceQuery) querySpec() *sqlgraph.QuerySpec {
...
func (_q *RaceQuery) sqlQuery(ctx context.Context) *sql.Selector {
...
func (_g *RaceGroupBy) Aggregate(fns ...AggregateFunc) *RaceGroupBy {
	_g.fns = append(_g.fns, fns...)
	return _g
}

// Scan applies the selector query and scans the result into the given value.
func (_g *RaceGroupBy) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _g.build.ctx, ent.OpQueryGroupBy)
	if err := _g.build.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*RaceQuery, *RaceGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *RaceGroupBy) sqlScan(ctx context.Context, root *RaceQuery, v any) error {
...
func (_s *RaceSelect) Aggregate(fns ...AggregateFunc) *RaceSelect {
	_s.fns = append(_s.fns, fns...)
	return _s
}

// Scan applies the selector query and scans the result into the given value.
func (_s *RaceSelect) Scan(ctx context.Context, v any) error {
	ctx = setContextOp(ctx, _s.ctx, ent.OpQuerySelect)
	if err := _s.prepareQuery(ctx); err != nil {
		return err
	}
	return scanWithInterceptors[*RaceQuery, *RaceSelect](ctx, _s.RaceQuery, _s, _s.inters, v)
}

func (_s *RaceSelect) sqlScan(ctx context.Context, root *RaceQuery, v any) error {
