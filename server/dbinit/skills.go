...
// InitSkillsAndTalents creates default classless skills if they don't exist
func InitSkillsAndTalents(client *db.Client) error {
	...
	// Create the 5 classless skills — universal (no race/class requirements)
	...
	log.Println("Classless skills initialized successfully")
	return nil
}
